...
static this() {
    ...
    Bindings globals = [
        ...
        "__currentTime" : Value(&notImplemented), //123
        ...
        "__nixPath" : Value(&notImplemented), "__nixVersion" : Value("2.3.4"), //FIXME
        ...
        "__toPath" : Value(&notImplemented), "toString" : Value(&notImplemented),
...
unittest {
    ...
    // assert(eval(att) == Value(["a": Value("ok"), "true": Value(true), "b": Value("ok")]));
